...
export const URL_CONFIGURABLE_PROVIDERS = ['Ollama', 'Ollama (Mock)', 'Ollama (Working)', 'LMStudio', 'OpenAILike'];
export const LOCAL_PROVIDERS = ['OpenAILike', 'LMStudio', 'Ollama', 'Ollama (Mock)', 'Ollama (Working)'];
