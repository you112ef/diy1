...
export const STARTER_TEMPLATES: Template[] = [
  ...
  {
    name: 'SolidJS',
    label: 'SolidJS Starter',
    description: 'SolidJS starter template with TypeScript for building reactive web applications',
    githubRepo: 'xKevIsDev/bolt-solidjs-template',
    tags: ['solidjs', 'typescript', 'reactive', 'frontend'],
    icon: 'i-bolt:solidjs',
  },
  {
    name: 'bolt-vue',
